        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-8">
            ...
            <div className="w-64 space-y-1">
              <button className="w-full flex items-center gap-3 p-3 text-left text-sm font-medium bg-primary/10 text-primary rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-background border border-border rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="bg-error-100 text-error-700 px-2 py-1 rounded text-xs font-medium">Not Available</span>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Handles the sending of emails for notifications, alerts, and user communications.
                    </p>
                  </div>
                </div>
              </div>
