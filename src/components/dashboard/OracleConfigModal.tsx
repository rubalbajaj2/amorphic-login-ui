...
interface OracleConfigModalProps {
  isOpen: boolean;
  onClose: () => void;
  onBack: () => void;
}
...
export const OracleConfigModal = ({ isOpen, onClose, onBack }: OracleConfigModalProps) => {
  ...
  const handleCreate = () => {
    if (validateForm()) {
      console.log("Creating Oracle datasource:", formData);
      onClose();
    }
  };
      ...
      <div className="relative bg-card rounded-lg shadow-xl p-6 max-w-md w-full mx-4 max-h-[90vh] flex flex-col animate-scale-in">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="space-y-6">
            {/* Section Title */}
            <div>
              <h3 className="font-medium text-foreground mb-1">Oracle Configuration details</h3>
